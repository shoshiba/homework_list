...
def create_comparison_dataframe(dfs: list, num_rivals: int):
    """比較用のデータフレームを作成する"""
    comparison_data = {
        "Level": dfs["me"]["Level"],
        "Title": dfs["me"]["Title"],
    ...
    for i in range(1, num_rivals + 1):
        ...
        comparison_data[f"vsRival{i}"] = (
            dfs["me"]["Details_Number"] - dfs[key]["Details_Number"]
        )
